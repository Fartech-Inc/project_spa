    ...
    <form action="{{  route('web.booking.process') }}" method="POST">
        ...
        <div class="bg-white mx-36 rounded-xl p-10">
            ...
            <div class="flex items-center justify-between">
                ...
                <svg fill="#FF48B6" height="1rem" width="1rem" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330 330" xml:space="preserve">
                ...
                <div class="w-1/2">
                    ...
                    <div class="mb-8 flex items-center gap-3 border rounded-full py-2 px-4 w-full">
                        <svg width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <circle cx="12" cy="9" r="3" stroke="#FF48B6" stroke-width="1.2"></circle>
                                <path d="M17.9691 20C17.81 17.1085 16.9247 15 11.9999 15C7.07521 15 6.18991 17.1085 6.03076 20" stroke="#FF48B6" stroke-width="1.2" stroke-linecap="round"></path>
                                <path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#FF48B6" stroke-width="1.2" stroke-linecap="round"></path>
                            </g>
                        </svg>
                    ...
                    <div class="flex items-center gap-3 border rounded-full py-2 px-4 w-full">
                        <svg width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path d="M10.0376 5.31617L10.6866 6.4791C11.2723 7.52858 11.0372 8.90532 10.1147 9.8278C10.1147 9.8278 10.1147 9.8278 10.1147 9.8278C10.1146 9.82792 8.99588 10.9468 11.0245 12.9755C13.0525 15.0035 14.1714 13.8861 14.1722 13.8853C14.1722 13.8853 14.1722 13.8853 14.1722 13.8853C15.0947 12.9628 16.4714 12.7277 17.5209 13.3134L18.6838 13.9624C20.2686 14.8468 20.4557 17.0692 19.0628 18.4622C18.2258 19.2992 17.2004 19.9505 16.0669 19.9934C14.1588 20.0658 10.9183 19.5829 7.6677 16.3323C4.41713 13.0817 3.93421 9.84122 4.00655 7.93309C4.04952 6.7996 4.7008 5.77423 5.53781 4.93723C6.93076 3.54428 9.15317 3.73144 10.0376 5.31617Z" fill="#FF48B6"></path>
                            </g>
                        </svg>
                ...
                <div class="w-1/2">
                    ...
                    <div class="mb-8 flex items-center gap-3 border rounded-full py-2 px-4 w-full">
                        <svg width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path d="M21 8L17.4392 9.97822C15.454 11.0811 14.4614 11.6326 13.4102 11.8488C12.4798 12.0401 11.5202 12.0401 10.5898 11.8488C9.53864 11.6326 8.54603 11.0811 6.5608 9.97822L3 8M6.2 19H17.8C18.9201 19 19.4802 19 19.908 18.782C20.2843 18.5903 20.5903 18.2843 20.782 17.908C21 17.4802 21 16.9201 21 15.8V8.2C21 7.0799 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V15.8C3 16.9201 3 17.4802 3.21799 17.908C3.40973 18.2843 3.71569 18.5903 4.09202 18.782C4.51984 19 5.07989 19 6.2 19Z" stroke="#FF48B6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            </g>
                        </svg>
                    ...
                    <div class="flex items-center gap-3 border rounded-full py-2 px-4 w-full">
                        ...
                        <input type="date" class="border rounded-full py-2 px-4 w-1/2" name="transaction_date" required value="{{ old('transaction_date') }}">
                    </div>
                </div>
            </div>
            <div class="my-5">
                <p>Waktu Pemesanan</p>
                <div class="flex items-center gap-3 border rounded-full py-2 px-4 w-full">
                    <svg width="2rem" height="2rem" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#FF48B6">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M5 0H11L11.3803 3.0421C12.7003 3.94382 13.6417 5.35897 13.917 7H15V9H13.917C13.6417 10.641 12.7003 12.0562 11.3803 12.9579L11 16H5L4.61974 12.9579C3.03812 11.8775 2 10.06 2 8C2 5.94003 3.03812 4.12252 4.61974 3.0421L5 0ZM7 5V8.41421L9.29289 10.7071L10.7071 9.29289L9 7.58579V5H7Z" fill="#FF48B6"></path>
                        </g>
                    </svg>
                    <div class="flex items-center font-bold gap-2">
                        <input type="time" class="border rounded-full py-2 px-4 w-1/2" name="start_time" value="{{ old('start_time') }}" required>
                        <p>-</p>
                        <input type="time" class="border rounded-full py-2 px-4 w-1/2" name="end_time" value="{{ old('end_time') }}" required>
                    </div>
                </div>
            </div>
        </div>
        <div class="bg-white mx-36 rounded-xl p-10 my-10">
            ...
            <div class="grid grid-cols-3 my-5">
                ...
                <button type="button"
                    ...
                    <img src="{{ '/storage/' . $product->image }}" alt="imgproduct" class="hover:w-56 transition w-56">
            ...
            <div class="flex justify-between gap-3 py-2 px-4 w-full">
                <div class="flex items-center gap-3">
                    <svg width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M22 6V8.42C22 10 21 11 19.42 11H16V4.01C16 2.9 16.91 2 18.02 2C19.11 2.01 20.11 2.45 20.83 3.17C21.55 3.9 22 4.9 22 6Z" stroke="#FF48B6" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M2 7V21C2 21.83 2.93998 22.3 3.59998 21.8L5.31 20.52C5.71 20.22 6.27 20.26 6.63 20.62L8.28998 22.29C8.67998 22.68 9.32002 22.68 9.71002 22.29L11.39 20.61C11.74 20.26 12.3 20.22 12.69 20.52L14.4 21.8C15.06 22.29 16 21.82 16 21V4C16 2.9 16.9 2 18 2H7H6C3 2 2 3.79 2 6V7Z" stroke="#FF48B6" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path opacity="0.4" d="M6 9H12" stroke="#FF48B6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path opacity="0.4" d="M6.75 13H11.25" stroke="#FF48B6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                    </svg>
